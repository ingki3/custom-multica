...
// Gemini, Pi, Cursor, Kimi, Kiro, Antigravity). It mirrors the happy-cli AgentBackend
...
// Supported types: "claude", "codex", "copilot", "opencode", "openclaw", "hermes", "gemini", "pi", "cursor", "kimi", "kiro", "agy".
func New(agentType string, cfg Config) (Backend, error) {
	...
	case "agy":
		return &agyBackend{cfg: cfg}, nil
	default:
		return nil, fmt.Errorf("unknown agent type: %q (supported: claude, codex, copilot, opencode, openclaw, hermes, gemini, pi, cursor, kimi, kiro, agy)", agentType)
	}
}
